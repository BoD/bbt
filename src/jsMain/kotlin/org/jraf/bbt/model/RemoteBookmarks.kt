...
//    }
    ...
    suspend fun parseRssOrAtom(text: String): BookmarksDocument? {
      logd("before createDocument")
      try {
        ...
        logd("Error calling createDocument: ${t.message} %O", t.stackTraceToString())
      }
      logd("after createDocument")
      return null
